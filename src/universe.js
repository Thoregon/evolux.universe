...
const unload = require('unload/src/index');
...
class Universe {
    ...
    freeze() {
        ...
        let duskTimeout = setTimeout(() => process.abort(), MAX_DUSK_TIMEOUT );
...
const universeHandler = {
    ...
    get: (universe, property) => {
        ...
        // if value is a function return a function which changes the context (this) to the universe
        // otherwise 'this' will be the Proxy which is not intended
...
// register at the global namespace
// if (window) window.universe = puniverse;
if (global) global.universe = puniverse;
