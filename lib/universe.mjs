...
import { logger }                   from './thoregonhelper.mjs';
...
class Universe extends DeferredProperties(Object) {
    ...
    register(name, object) {
        ...
        // _this[name] = object.$access ? object.$access : AccessObserver.observe(object, _this);
        _this[name] = AccessObserver.observe(object, _this);
...
const handler = {
    ...
    get(target, prop, receiver) {
        ...
        if (prop.startsWith('_') && !prop.startsWith('$')) return undefined;
