...
export default function letThereBeLight(configfn) {
    return new Promise(async (resolve,reject) => {
        ...
        try {
            ...
            if (isFunction(configfn)) {
                ...
                const configpath = `/setup/universe.remote.config.js`;
                exports = await import(configpath); // await import('/etc/universe.config.mjs');
            }
