...
export default function letThereBeLight(configname) {
    return new Promise(async (resolve,reject) => {
        ...
        try {
            ...
            const configpath = `/setup/${configname ?? 'universe.config'}.mjs`;
            let exports = await import(configpath); // await import('/etc/universe.config.mjs');
            ...
            try {
                ...
                exports            = await import('/setup/' + extendedconf);
