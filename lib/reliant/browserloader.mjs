...
export default class BrowserLoader extends Reporter(Object) {
...
*/
    ...
    async sendModuleFile(url, req, res) {
    ...
    // todo: - this produces an export which represents the structure on the sovereign node (this)
    //         but not the structure on the reliant node!! Should be the same, but there may be differences
    //       - there may also be timing problems, when this script is cached, but new entries are made
