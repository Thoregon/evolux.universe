...
const thoregon          = new ThoregonLoader({ root: './', cachelocation: './.thoregon/jscache'});

export default class Bootloader {

    constructor() {
        thoregon.ensureCache();
    }
    ...
    async resolve(specifier, parentModuleURL = baseURL, defaultResolve) {
        ...
        if (thoregon.isThoregon(specifier)) return thoregon.resolveThoregon(specifier, resolved);
