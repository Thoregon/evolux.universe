...
const ROOTPATH          = '/Entw/Projects/ThoregonUniverse';
const EVOLUXPATH        = `${ROOTPATH}${EVOLUXPREFIX}modules`;
const THOREGONPATH      = `${ROOTPATH}${THOREGONPREFIX}modules`;
const ABISHADIAPATH     = `${ROOTPATH}${ABISHADIAPREFIX}modules`;
