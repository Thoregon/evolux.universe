/**
 * The Client Universe is the runtime context for the platform.
...
import dependencies from "./reliant/dependencies.mjs"
 ...
 *
 */
class UniverseC extends Universe {
