...
*/
    ...
    set(target, prop, value, receiver) {
        ...
        if (!isPrivateProperty(prop)) this.emit('change', { obj: receiver, property: prop, newValue: value, oldValue });
    ...
    deleteProperty(target, prop, receiver) {
        ...
        if (prop in target) {
            ...
            if (!isPrivateProperty(prop)) this.emit('change', { obj: receiver, property: prop, oldValue, newValue: undefined });
            target.metaClass?.emitEntityEvents(receiver);
        }
        return true;
    }
