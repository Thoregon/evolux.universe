...
if ('universe-mydev.js' != setup.env.universe) {
    failure++;
    console.log("$$ Err: config is '" + setup.env.universe + "' instead of 'universe-mydev.js'");
}

console.log(">> Test: Setup3", (failure ? failure + " failures" : "all tests passed"));
